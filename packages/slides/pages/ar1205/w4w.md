...
color: zinc
background: https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Jan_Vermeer_-_The_Art_of_Painting_-_Google_Art_Project.jpg/1920px-Jan_Vermeer_-_The_Art_of_Painting_-_Google_Art_Project.jpg
title: "Week 4: <b>Wed, Jan 28</b> &  <b>Fri, Jan 30</b>"
level: 1
---

Colonialism and Global Trade
## Mapping the Dutch Golden Age & Art in Encounters
#### WEEK 4
...
## Map as a mode of representation and knowledge

:: content :: 

![Willem Blaeu, _Map of the World_, 1635](https://res.cloudinary.com/image-solar/image/upload/v1770392159/2026nwp-ar1205/Picture1_xqov5z.jpg)

<!-- 
- Map as a form of knowledge production and representation
- The Dutch Golden Age and global trade routes
- Still-life painting and cultural exchange in the Baroque period
...
![First European map of Tenochtitlan.](https://upload.wikimedia.org/wikipedia/commons/8/8f/First_European_map_of_Tenochtitlan.jpg)

<div v-drag="[688,111,206,208]" v-click="[1]">

![](https://i.pinimg.com/564x/66/2b/64/662b64652d9b65ab3e3a34409a74db31.jpg)
</div>
...
![Johannes Vermeer, The Art of Painting, 1666-69, oil on canvas, 130 x 110 cm](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Jan_Vermeer_-_The_Art_of_Painting_-_Google_Art_Project.jpg/1920px-Jan_Vermeer_-_The_Art_of_Painting_-_Google_Art_Project.jpg)


---

![ A map of the Seventeen Provinces of Low Germanie (Low Countries, Netherlands). Made by the English cartographer John Speed (1552-1629)](https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Map_of_Seventeen_Provinces_of_Low_Germanie_%28Zeventien_Provincien_der_Nederlanden%29_1626.jpg/3840px-Map_of_Seventeen_Provinces_of_Low_Germanie_%28Zeventien_Provincien_der_Nederlanden%29_1626.jpg)

<!-- 


https://www.essentialvermeer.com/maps/vermeers-maps.html

 -->

---

![The Dutch Empire in 1674](https://smarthistory.org/wp-content/uploads/2021/02/Dutchempire1674.png)

<div v-drag="[608,145,346,298]" v-click="[1]">

<div>

![Map of the Dutch and Portuguese in Asia c. 1665](https://smarthistory.org/wp-content/uploads/2021/02/Dutch_and_Portuguese_in_Asia_c_1665.png)
</div>
</div>
...
events:
  - year: "1568"
    title: "Dutch Revolt Begins"
    description: "• Eighty Years' War starts• William of Orange leads rebellion against Spanish rule• Beginning of Dutch independence movement"
    icon: war
    color: red
  - year: "1581"
    title: "Act of Abjuration"
    description: "• Dutch declare independence from Spain• Establishment of Dutch Republic• Foundation of religious tolerance"
    icon: flag
    color: navy
  - year: "1602"
    title: "VOC Founded"
    description: "• Dutch East India Company established• First multinational corporation• World's first stock IPO• Dominates Asian trade"
    icon: ship
    color: teal
  - year: "1609"
    title: "Twelve Years' Truce"
    description: "• Temporary peace with Spain• Dutch Republic gains recognition• Economic expansion begins• Golden Age accelerates"
    icon: peace
    color: green
  - year: "1621"
    title: "WIC Founded"
    description: "• Dutch West India Company established• Monopoly on Atlantic trade• Deeply involved in transatlantic slave trade• Operates in West Africa, Americas, Caribbean"
    icon: ship
    color: orange
  - year: "1634-1637"
    title: "*Tulip Mania* Peaks & Crashes"
    description: "• Single bulb sells for 10x artisan's annual salary• Market collapses February 1637• Fortunes lost overnight• Early example of speculative bubble"
    icon: alert
    color: red
  - year: "1630s-1863"
    title: "Dutch Slave Trade"
    description: "• WIC transports ~500,000 enslaved Africans• Plantations in Suriname, Caribbean colonies• Forced labor fuels Dutch prosperity• Wealth built on human suffering"
    icon: chains
    color: purple
  - year: "1648"
    title: "Peace of Münster"
    description: "• Official independence from Spain• End of Eighty Years' War• Dutch Republic recognized globally• Height of Golden Age"
    icon: flag
    color: navy
  - year: "1652-1674"
    title: "Anglo-Dutch Wars"
    description: "• Trade conflicts with England• Naval battles for supremacy• New York captured (1664)• Shift in global power"
    icon: war
    color: red
  - year: "1669"
    title: "*Rembrandt* Dies"
    description: "• End of greatest Dutch master• Marked decline of Golden Age• Artistic legacy established• Influence on future generations"
    icon: art
    color: zinc
  - year: "1675"
    title: "*Vermeer* Dies"
    description: "• Death of another Dutch master• Forgotten until 19th century• Rediscovered by French critics• Now considered among greatest painters"
    icon: art
    color: sky
  - year: "1688"
    title: "Glorious Revolution"
    description: "• Dutch Stadtholder becomes William III of England• Dutch-English alliance• Shift of economic center to London• End of Dutch Golden Age"
    icon: revolution
    color: orange
---
...
![Shah Suleiman I and his courtiers, folio from the St. Petersburg Album. Isfahan, 1670. Two greatly distorted Georgian inscriptions are visible above the two figures at the top left.](https://upload.wikimedia.org/wikipedia/commons/1/18/Ali_Culi_Jabbadar_001.jpg)

:: right ::

![17th-century Dutch Dejima, Japan](https://upload.wikimedia.org/wikipedia/commons/9/9a/DutchDejima.png)

<!-- 
In the court of Shah Suleiman I, the Safavid ruler of Iran, we see a scene of cultural exchange and global trade. The presence of European-style clothing and the depiction of foreign visitors suggest the influence of global trade routes and interactions with European powers during the 17th century.

Dejima (Japanese: 出島; lit. 'exit island') or Deshima,[a] in the 17th century also called Tsukishima (築島; lit. 'built island'), was an artificial island off Nagasaki, Japan, that served as a trading post for the Portuguese (1570–1639) and subsequently the Dutch (1641–1858).[1] For 220 years, it was the central conduit for foreign trade and cultural exchange with Japan during the isolationist Edo period (1600–1869), and the only Japanese territory open to Westerners

- the dutch were the only westerners allowed to trade with Japan during the Edo period, and they were confined to Dejima, an artificial island in Nagasaki harbor. This limited contact allowed for a unique cultural exchange, where Dutch goods and knowledge influenced Japanese art, science, and technology, while Japanese culture also left its mark on Dutch art and fashion.

- the dutch are recognizable in the painting by their distinctive clothing, which includes wide-brimmed hats, doublets, and breeches. The presence of these foreign figures in the Safavid court highlights the interconnectedness of global trade networks during the 17th century and the cultural exchanges that occurred as a result of these interactions.
...
### Landscape Painting ✏️ as Mapping the World

<br>

### The word "landscape" entered the modern English language as _landskip_ (variously _spelt_), an anglicization of the Dutch landschap, around the start of the 17th century, purely as a term for works ofart, with its first use as a word for a painting in 1598.

<!-- Landscape painting in the Baroque period often served as a way to map and represent the world, reflecting the expanding horizons of European exploration and colonization. Artists like Jacob van Ruisdael and Aelbert Cuyp depicted vast, detailed landscapes that not only showcased the beauty of nature but also symbolized the growing knowledge and control over the environment. These paintings often included elements such as ships, exotic flora and fauna, and distant horizons, which conveyed a sense of discovery and the global reach of European powers during this era. -->
...
![Andries Beeckman, The Castle of Batavia, c. 1661, oil on canvas, 151.5 x 108 cm](https://smarthistory.org/wp-content/uploads/2021/02/batavia-castle-full-scaled-1-scaled.jpg)
...
![Kalf, Willem: Pronk Still Life with Holbein Bowl, Nautilus Cup, Glass Goblet, and Fruit Dish](https://cdn.britannica.com/91/190391-050-985C9AAB/Pronk-Still-Life-canvas-Nautilus-Cup-Holbein.jpg)

:: left ::

### Still-Life Painting ✏️, Trade Routes, and Cultural Exchange in the Baroque Period
...
The wealthy inhabitants of Amsterdam found Kalf’s work irresistible. His banquet pieces and lavish representations of fine objects were in great demand.

### paintin: A Review of the Global Baroqueg
...
### still life painting
Still-life painting emerged as a major genre in the Baroque period, particularly in the Dutch Republic, where artists like Pieter Claesz and Willem Kalf created intricate compositions featuring everyday objects, food, and luxury items. These paintings often carried symbolic meanings related to the transience of life (vanitas themes) and the wealth generated through global trade.
...
![Willem Kalf, _Willem: Pronk Still Life with Holbein Bowl, Nautilus Cup, Glass Goblet, and Fruit Dish_](https://cdn.britannica.com/91/190391-050-985C9AAB/Pronk-Still-Life-canvas-Nautilus-Cup-Holbein.jpg)
...
![Antonio de Pereda, _Still Life with Ebony Chest_, 1652, oil on canvas, 80 x 94 cm](https://smarthistory.org/wp-content/uploads/2018/09/Pereda-still-life-thumb.jpg)
...
![](https://smarthistory.org/wp-content/uploads/2022/06/large-07d7a9afc0e4dfc48eaecb8660763651ecf81652-scaled.jpeg)
...
<div v-drag="[634,24,337,301]" v-click="[1]">

<div>

![Camera Obscura](https://res.cloudinary.com/image-solar/image/upload/v1770393250/camera-obscura-19_k9sudd.jpg)
</div>
</div>

<!--
- painting in painting
- the lady in blue is Clio, the muse of history, who holds a trumpet and a book, symbols of fame and knowledge. The map on the back wall is a map of the Netherlands, which was a common motif in Dutch Golden Age paintings and often symbolized national pride and identity.
- Look at the curtain that’s been drawn back, that takes up the top quarter of the painting. We’re looking at a scene that we don’t normally get to see.
-  Look at the artist. He’s dressed up too. He’s dressed up the model, but he’s wearing something fancier than the artist would traditionally wear in the studio. This black vest that has these openings and slits in it, and this really nice hat. The bright orange leggings.
-  in the 18th cent, Vermeer was felt off fashion and his work was not widely known. But in the 19th century, he was rediscovered by art critics and collectors, and his paintings became highly sought after. Today, Vermeer is considered one of the greatest painters of the Dutch Golden Age, and his works are celebrated for their exquisite detail, use of light, and ability to capture the quiet beauty of everyday life.
-  hitler bought the painting in 1940, and it was displayed in the Führermuseum in Linz, Austria. After World War II, the painting was recovered by the Allies and returned to the Netherlands. It is now housed in the Kunsthistorisches Museum in Vienna, Austria.

### Camera Obscura
It was a device that projected an image of the outside world onto a surface inside a darkened room or box. It was used by artists like Vermeer to achieve accurate perspective and lighting in their paintings. The camera obscura allowed artists to trace the projected image, helping them to create more realistic and detailed works of art.

image: Illustration showing how to operate a camera obscura in The American educator; completely remodelled and rewritten from original text of the New practical reference library, with new plans and additional material (vol. 2; p. 652)
